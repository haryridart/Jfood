...
public class DatabaseCustomerPostgre extends DatabaseConnectionPostgre{
    ...
    public static Boolean insertCustomer(Customer customer) throws EmailAlreadyExistsException
    {
        ...
        try {
            statement = c.prepareStatement("INSERT INTO customer (id,name, email, password) values (?,?,?,?) RETURNING id;");
    ...
    public static Customer getCustomer(String customerEmail, String customerPassword)
    {
        ...
        try {
            statement = c.prepareStatement("SELECT id, name, email, password from customer where email=? and password=?;");
    ...
    public static ArrayList<Customer> getCustomerDatabase()
    {
        ...
        try {
            ...
            while(rs.next()){
                ...
                customer = new Customer (id, customerName, customerEmail, customerPassword);
